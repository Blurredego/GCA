                ...
                <div className="container cnt-center   ">
                    <div className="row align-items-center">
                        <div className="col-lg-8 col-md-8">
                            ...
                            <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Stay updated with the latest developments, industry insights, and success stories from our <br className="d-none d-lg-block "/><span> global network of freight forwarders.</span> </p>
                        </div>
                        <div className="col-lg-4 col-md-4 text-end">
                            <div className="box-button-sliders box-pagination-customers w-36 max-sm:hidden flex gap-4">
                            <div className="box-pagination-customers w-36 max-sm:hidden flex gap-3 ">
