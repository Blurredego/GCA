...
import CountUp from '../elements/CounterUp';
        ...
        <>
            <section className="section bg-leading-company pt-95">
                ...
                <div className="cnt-center container">
                    <div className="mb-45 text-center">
                        <h2 className="color-main mb-15 wow animate__animated animate__fadeIn">
                    ...
                    <div className="row flex justify-center max-lg:gap-2 lg:gap-4 ">
                        <div className="col-md-5 col-sm-4 mb-30 lg:w-[24%]">
                            <div className="cardLeadingCompany">
                                <div className="cardImage">
                                    <span className="img wow animate__animated animate__fadeIn">
                                        <img src="/assets/imgs/page/homepage1/handover.png" alt="transp" />
                                    </span>
                                </div>
                                <div className="cardInfo">
                                    <h3 className="color-main wow animate__animated animate__fadeIn">
                                        <span>+</span>
                                        <span className="counterUp">{inViewport && <CountUp end={254} duration={10} />}</span>
                                    </h3>
                                    <p className="font-lg color-white wow animate__animated animate__fadeIn">Parcels Shipped Safely</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-5 col-sm-4 mb-30 lg:w-[24%]">
                            <div className="cardLeadingCompany">
                                <div className="cardImage">
                                    <span className="img">
                                        <img src="/assets/imgs/page/homepage1/cities.png" alt="transp" />
                                    </span>
                                </div>
                                <div className="cardInfo">
                                    <h3 className="color-main wow animate__animated animate__fadeIn">
                                        <span>+</span>
                                        <span className="count">{inViewport && <CountUp end={457} duration={10} />}</span>
                                    </h3>
                                    <p className="font-lg color-white wow animate__animated animate__fadeIn">Cities Served Worldwide</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-5 col-sm-4 mb-30 lg:w-[24%]">
                            <div className="cardLeadingCompany">
                                <div className="cardImage">
                                    <span className="img">
                                        <img src="/assets/imgs/page/homepage1/client.png" alt="transp" />
                                    </span>
                                </div>
                                <div className="cardInfo">
                                    <h3 className="color-main wow animate__animated animate__fadeIn">
                                        <span>+</span>
                                        <span className="count">{inViewport && <CountUp end={384} duration={10} />}</span>
                                    </h3>
                                    <p className="font-lg color-white wow animate__animated animate__fadeIn">Satisfied Clients</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-5 col-sm-4 mb-30 lg:w-[24%]">
                            <div className="cardLeadingCompany">
                                <div className="cardImage">
                                    <span className="img">
                                        <img src="/assets/imgs/page/homepage1/company.png" alt="transp" />
                                    </span>
                                </div>
                                <div className="cardInfo">
                                    <h3 className="color-main wow animate__animated animate__fadeIn">
                                        <span>+</span>
                                        <span className="count">{inViewport && <CountUp end={483} duration={10} />}</span>
                                    </h3>
                        ...
                        <div className="row ">
                            ...
                            <div className="col-lg-4">
                                <div className="box-image-contact">
                                    <img src="/assets/imgs/page/homepage1/img-contact.png" alt="transp" />
                                </div>
                            </div>
                        </div>
                    </div>
