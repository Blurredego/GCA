                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-12">
                                    ...
                                    <div className="box-button mt-30 flex h-10 ">
                                        ...
                                        <a className="btn btn-play popup-youtube hover-up wow animate__animated animate__fadeInUp shadow-none" onClick={() => setOpen(true)}>
                                            <img className="wow animate__animated animate__fadeInUp" src="/assets/imgs/template/icons/play.svg" alt="" />
                                            How it work ?
                                        </a>
                                    </div>
                                </div>
