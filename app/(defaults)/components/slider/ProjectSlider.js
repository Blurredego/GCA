...
export default function ProjectSlider() {
    return (
        <>
                    ...
                    <div className="cardGrid">
                        ...
                        <div className="cardInfo">
                            ...
                            <p className="font-xs color-grey-500">Aut ducimus inventore aut nihil
                                ...
                                fugit architecto</p>
                            <div className="box-button-offer mt-10"><a className="btn btn-link font-sm color-brand-2">View Details<span>
            ...
            <div className="box-pagination-customers text-center wow animate__animated animate__fadeIn max-sm:-top-4 ">
