...
const ConferenceMoments = () => {
    ...
    const nextMoment = () => {
        setCurrentMoment((prev) => (prev < totalMoments ? prev + 1 : prev));
    };

    const prevMoment = () => {
        setCurrentMoment((prev) => (prev > 1 ? prev - 1 : prev));
    };
        ...
        <div className="flex max-lg:flex-col lg:h-[741px]">
            ...
            <div className="event-slider-left flex flex-col justify-between p-8 pl-32 max-lg:items-start max-lg:p-4 max-lg:pl-3 lg:w-[738px]">
                <div className="mx-auto  justify-between gap-3  p-[38px] max-lg:flex   max-lg:p-3">
                    <h2 className="mb-8 text-nowrap  text-3xl font-bold text-white max-lg:text-wrap md:text-5xl lg:text-3xl">Moments of Conference</h2>

                    <div className="flex-row-reverse items-start  max-lg:mt-5 justify-start text-2xl text-white max-lg:flex  ">


                        <div className="box-pagination-customers  lg:pb-16 max-lg:relative max-lg:-ml-32  lg:space-y-6 gap-8 max-sm:gap-2 justify-center max-lg:flex flex-row-reverse">
                            <div
                ...
                <div className="text-6xl font-light text-white max-lg:hidden ">
                    ...
                    <div className="progress-container mt-2 h-2 w-40 rounded-md bg-gray-300">
                        <div className="progress-bar h-full   bg-gray-900" style={{ width: `${(currentMoment / totalMoments) * 100}%` }}></div>
                    </div>
                </div>
            </div>
            {/* Right section */}
