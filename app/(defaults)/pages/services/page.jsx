                            ...
                            <div className="mb-50 wow  animate__animated animate__fadeIn md:w-[40%] lg:w-[31%]">
                                <div className="cardService">
                                    ...
                                    <div className="cardInfo">
                                        {' '}
                                        <Link href="/service-detail">
                                            <Image className="h-fit w-fit" src={networking.src} alt="gca" width={42} height={42} />
                            ...
                            <div className="mb-50 wow  animate__animated animate__fadeIn md:w-[40%] lg:w-[31%]">
                                <div className="cardService">
                                    ...
                                    <div className="cardInfo">
                                        {' '}
                                        <Link href="/service-detail">
                                            <Image className="h-fit w-fit" src={marketing.src} alt="Financial" width={42} height={42} />
                            ...
                            <div className="mb-50 wow  animate__animated animate__fadeIn md:w-[40%] lg:w-[31%]">
                                <div className="cardService">
                                    ...
                                    <div className="cardInfo">
                                        {' '}
                                        <Link href="/service-detail">
                                            <Image className="h-fit w-fit" src={marketing.src} alt="Marketing" width={42} height={42} />
                            ...
                            <div className="mb-50 wow  animate__animated animate__fadeIn md:w-[40%] lg:w-[31%]">
                                <div className="cardService">
                                    ...
                                    <div className="cardInfo">
                                        {' '}
                                        <Link href="/service-detail">
                                            <Image className="h-fit w-fit" src={Insurance.src} alt="Insurance" width={42} height={42} />
