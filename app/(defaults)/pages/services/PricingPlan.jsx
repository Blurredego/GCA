        ...
        <>
            <section className="section pt-110 pb-50">
                <div className="container cnt-center">
                    ...
                    <div className="row mt-50 align-items-end pricing-style-2 flex justify-evenly">
                        <div className="col-xl-3 lg:w-[23%] col-md-5 wow animate__animated animate__fadeIn">
