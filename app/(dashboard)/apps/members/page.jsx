            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                    <div className="flex gap-3">
                        <div>
                            <button type="button" className="btn btn-primary px-2 " onClick={() => editUser()}>
                                <IconUserPlus className="2 ltr:mr-2 rtl:ml-2" />
                                Add Members
                            </button>
                        </div>
                        <div>
                    ...
                    <div className="relative">
                        <input type="text" placeholder="Search Members" className="peer form-input py-2 ltr:pr-11 rtl:pl-11" value={search} onChange={(e) => setSearch(e.target.value)} />
                                            ...
                                            <td>
                                                ...
                                                <Link href="/profile">
                                                 View
                                                    ...
                                                    <button type="button" className="btn btn-outline-danger px-3" onClick={() => deleteUser(contact)}>
                                                        Delete
                                                    </button> */}
                                                </div>
                                            </td>
                        ...
                        return (
                            <div className="relative overflow-hidden rounded-md bg-white text-center shadow dark:bg-[#1c232f]" key={contact.id}>
                                <div className="relative overflow-hidden rounded-md bg-white text-center shadow dark:bg-[#1c232f]">
                                    <div className="relative h-[200px] w-[388px]  rounded-t-md bg-white/40 bg-[url('/assets/images/notification-bg.webp')] bg-cover bg-center p-6 pb-0">
                                    
                                        <div className="absolute bottom-20 left-40 z-10 flex h-[87px] w-[87px] items-center justify-center rounded-full border border-red-600 bg-white">
                                            <img className="h-14 w-14" src={`/assets/images/${contact.path}`} alt="contact_image" />
                                        </div>
                                    </div>
                                    <div className="relative -mt-28 px-6 pb-24">
                                        <div className="rounded-md border-2 border-green-600 bg-white px-2 py-4   shadow-md dark:bg-gray-900">
                                            <div className=" flex justify-end">
                                                <Image src={`/assets/images/${contact.flag}`} alt="contact_image" width={50} height={30} className="h-fit w-fit rounded-lg " />
                                            </div>
                                            <div className="mt-4 text-xl">{contact.name}</div>
                                            <div className="text-white-dark">{contact.role}</div>
                                            <div className="mt-8">
                                                <ul className="flex items-center justify-center space-x-4 pt-10 rtl:space-x-reverse">
                                                    <li>
                                                        <button type="button" className="btn btn-outline-blue h-7 w-7 rounded-full p-0">
                                                            <IconFacebook />
                                                        </button>
                                                    </li>
                                                    <li>
                                    ...
                                    <button className='btn btn-outline-blue w-full'> <Link href="/profile">View</Link> </button>
                                        {/* <button type="button" className="btn btn-outline-blue w-1/2" onClick={() => editUser(contact)}>
                                            Edit
                                        </button>
                            ...
                            >
                                <Dialog.Panel className="panel w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                    ...
                                    <div className="bg-[#fbfbfb] py-3 text-lg font-medium dark:bg-[#121c2c] ltr:pl-5 ltr:pr-[50px] rtl:pl-[50px] rtl:pr-5">
                                        {params.id ? 'Edit Contact' : 'Add Members'}
                                    </div>
                                    <div className="p-5">
                                        <form>
                                            <div className="mb-5">
                                            ...
                                            <div className="mt-8 flex items-center justify-end">
                                                <button type="button" className="btn btn-outline-danger px-2 " onClick={() => setAddContactModal(false)}>
                                                    Cancel
                                                </button>
                                                <button type="button" className="btn btn-blue px-3 ltr:ml-4 rtl:mr-4" onClick={saveUser}>
