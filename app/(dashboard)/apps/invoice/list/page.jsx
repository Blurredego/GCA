...
const ComponentsAppsInvoiceList = () => {
    ...
    return (
     ...
     <title>Invoices | List</title>
        ...
        <ul className="flex space-x-2 rtl:space-x-reverse my-2 text-2xl">
                    <li>
                        <Link href="/apps/invoice" className="text-primary hover:underline">
                         Invoices    
                        </Link>
                    </li>
            ...
            <div className="invoice-table">
                <div className="mb-4.5 flex flex-col gap-5 px-5 md:flex-row md:items-center">
                    <div className="flex items-center gap-2">
                        <button type="button" className="btn btn-danger gap-2 btn-lg-d" onClick={() => deleteRow()}>
                            <IconTrashLines />
                            Delete
                        </button>
                        <Link href="/apps/invoice/add" className="btn btn-primary gap-2 btn-lg-d">
                            <IconPlus />
                            Add New
                        </Link>
                    </div>
