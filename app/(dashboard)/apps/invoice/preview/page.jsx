    ...
    return (
        ...
        <div>
            <div className="mb-6 flex flex-wrap items-center justify-center gap-4 lg:justify-end">
                <button type="button" className="btn btn-info gap-2 btn-lg-d">
                    <IconSend />
                    Send Invoice
                </button>

                <button type="button" className="btn btn-primary gap-2 btn-lg-d" onClick={() => exportTable()}>
                    <IconPrinter />
                    Print
                </button>

                <button type="button" className="btn btn-success gap-2 btn-lg-d">
                    <IconDownload /> 
                    Download
                </button>

                <Link href="/apps/invoice/add" className="btn btn-secondary gap-2 btn-lg-d">
                    <IconPlus />
                    Create
                </Link>

                <Link href="/apps/invoice/edit" className="btn btn-warning gap-2 btn-lg-d">
                    <IconEdit />
                    Edit
                </Link>
            </div>
