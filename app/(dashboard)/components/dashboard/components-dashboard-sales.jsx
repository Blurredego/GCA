...
import IconNetflix from '../icon/icon-netflix';
import IconBolt from '../icon/icon-bolt';
                ...
                <div className="pt-5">
                    <div className="mb-6 grid gap-6 xl:grid-cols-3">
                        ...
                        <div className="panel h-full">
                            <div className="mb-5 flex items-center">
                                <h5 className="h5-dashboard dark:text-white-light">Sales By Category</h5>
                            </div>
                            <div>
                                <div className="rounded-lg bg-white dark:bg-black">
                                    {isMounted ? (
                    ...
                    <div className="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                        <div className="panel h-full sm:col-span-2 xl:col-span-1">
                            <div className="mb-5 flex items-center">
                                <h5 className=" h5-dashboard dark:text-white-light">
                                    Daily Sales
                        ...
                        <div className="panel h-full">
                            <div className="mb-5 flex items-center justify-between dark:text-white-light">
                                <h5 className="h5-dashboard">Summary</h5>
                                <div className="dropdown">
                                    <Dropdown
                                        placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                    ...
                    <div className="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                        <div className="panel h-full pb-0 sm:col-span-2 xl:col-span-1">
                            <h5 className="mb-5 h5-dashboard dark:text-white-light">Recent Activities</h5>
                        ...
                        <div className="panel h-full">
                            <div className="mb-5 flex items-center justify-between dark:text-white-light">
                                <h5 className="h5-dashboard">Transactions</h5>
                                <div className="dropdown">
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <div className="panel h-full w-full">
                            <div className="mb-5 flex items-center justify-between">
                                <h5 className="h5-dashboard dark:text-white-light">Recent Orders</h5>
                            </div>
                        ...
                        <div className="panel h-full w-full">
                            <div className="mb-5 flex items-center justify-between">
                                <h5 className="h5-dashboard dark:text-white-light">Top Selling Product</h5>
                            </div>
                            <div className="table-responsive">
                                <table>
                                    <thead>
