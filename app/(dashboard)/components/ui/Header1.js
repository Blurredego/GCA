                        ...
                        <div className=" flex  justify-between ">
                            <div className="">
                                ...
                                <Link className="phone-icon mr-45" href="tel:+01-246-357">
                                    <svg fill="none" className="inline-block" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                        <path
                                            strokeLinecap="round"
                        ...
                        <div className="header-left">
                            ...
                            <div className="header-right">
                                <div className="box-dropdown-cart inline-block">
                                    <span className="icon-list icon-account text-lg">
                                        <span className="arrow-down text-sm text-gray-900">
                                            <svg fill="none" stroke="currentColor" className="inline-block" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path
                                                    strokeLinecap="round"
                                                    strokeLinejoin="round"
                                ...
                                <div className="hidden sm:inline-block ">
                                    <Link className="btn btn-default mr-2 inline-block shadow-none hover:bg-gray-200" href="/login">
                                        Login
                                    </Link>
                                    <Link className="btn btn-brand-1 hidden shadow-none hover:bg-blue-500 xl:inline-block" href="/request-a-quote">
