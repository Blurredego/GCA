...
import IconMenuUsers from '../icon/icon-menu';
...
import IconCaretsDown from '../icon/icon-carets-down';
import IconMenuMembers from '../icon/menu/icon-menu-members';
                            ...
                            <li className="nav-item">
                                        <Link href="/apps/members" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 font-normal dark:text-[#506690] dark:group-hover:text-white-dark">{t('members')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/apps/application" className="group">
                                            ...
                                            <IconMenuForms className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 font-normal dark:text-[#506690] dark:group-hover:text-white-dark">{t('applications')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'invoice' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('invoice')}>
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 font-normal dark:text-[#506690] dark:group-hover:text-white-dark">{t('invoice')}</span>
                                            </div>
                                    ...
                                    <li className="nav-item">
                                        <Link href="/apps/#" className="group">
                                            ...
                                            <IconMenuNotes className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 font-normal dark:text-[#506690] dark:group-hover:text-white-dark">{t('reviewedits')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                ...
                                <button type="button" className={`${currentMenu === 'users' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('users')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 font-normal rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('setting')}</span>
                                    </div>
...
{/* 
                            <h2 className="h2-dashboard -mx-4 mb-1 flex items-center  bg-white-light/30 px-[28px]  font-bold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                ...
                                <span className='dark:text-[#8185A0]'>{t('apps')}</span>
                            </h2>
...
{/* 
                            <h2 className="h2-dashboard -mx-4 mb-1 flex items-center bg-white-light/30 px-[28px] font-abold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span className='dark:text-[#8185A0]'>{t('user_interface')}</span>
                            </h2>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'component' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('component')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className=" font-normal  text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('components')}</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'element' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('element')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black font-normal ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('elements')}</span>
                                    </div>
                            ...
                            <h2 className="h2-dashboard -mx-4 mb-1 flex items-center bg-white-light/30 px-[28px] font-bold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span className='dark:text-[#8185A0]'>{t('tables_and_forms')}</span>
                            </h2>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'datalabel' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('datalabel')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 rtl:pr-3 font-normal dark:text-[#506690] dark:group-hover:text-white-dark">{t('datatables')}</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'forms' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('forms')}>
                                    <div className="flex items-center">
                                        <IconMenuForms className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 font-normal dark:text-[#506690] dark:group-hover:text-white-dark">{t('forms')}</span>
                                    </div>
                            ...
                            <h2 className="h2-dashboard -mx-4 mb-1 flex items-center bg-white-light/30 px-[28px]  font-bold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span className='dark:text-[#8185A0]'>{t('user_and_pages')}</span>
                            </h2>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'users' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('users')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 font-normal rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('users')}</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'page' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('page')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 rtl:pr-3 font-normal dark:text-[#506690] dark:group-hover:text-white-dark">{t('pages')}</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'auth' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('auth')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 font-normal rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('authentication')}</span>
                                    </div>
                            ...
                            <h2 className=" h2-dashboard -mx-4 mb-1 flex items-center bg-white-light/30 px-[28px]  font-bold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span className='dark:text-[#8185A0]'>{t('supports')}</span>
                            </h2>
                            ...
                            <li className="menu nav-item">
                                <Link href="https://vristo.sbthemes.com" target="_blank" className="nav-link group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 rtl:pr-3 font-noraml dark:text-[#506690] dark:group-hover:text-white-dark">{t('documentation')}</span>
                                    </div>
                                </Link>
                            </li> */}
                        </ul>
