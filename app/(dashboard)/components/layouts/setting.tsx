    ...
    return (
        <div>
            ...
            <nav
                ...
                } fixed bottom-0 top-0 z-[51] w-full max-w-[400px] bg-white py-2 px-3 shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 ltr:-right-[400px] rtl:-left-[400px] dark:bg-black`}
            >
                <button
                    type="button"
                ...
                <div className="perfect-scrollbar h-screen overflow-y-auto overflow-x-hidden">
                    <div className="relative pb-5 text-center">
                        ...
                        <h4 className="h4-dashboard   dark:text-white">TEMPLATE CUSTOMIZER</h4>
                        <p className="text-white-dark">Set preferences that will be cookied for your live preview demonstration.</p>
                    </div>

                    <div className="mb-[12px] rounded-md border border-dashed border-white-light p-[12px] dark:border-[#1b2e4b]">
                        <h5 className="h5-dashboard mb-1 text-base leading-none dark:text-white">Color Scheme</h5>
                    ...
                    <div className="mb-[12px] rounded-md border border-dashed border-white-light p-[12px] dark:border-[#1b2e4b]">
                        <h5 className="h5-dashboard mb-1 text-base leading-none dark:text-white">Navigation Position</h5>
                    ...
                    <div className="mb-[12px] rounded-md border border-dashed border-white-light p-[12px] dark:border-[#1b2e4b]">
                        <h5 className="h5-dashboard mb-1 text-base leading-none dark:text-white">Layout Style</h5>
                    ...
                    <div className="mb-[12px] rounded-md border border-dashed border-white-light p-[12px] dark:border-[#1b2e4b]">
                        <h5 className="h5-dashboard mb-1 text-base leading-none dark:text-white">Direction</h5>
                    ...
                    <div className="mb-[12px] rounded-md border border-dashed border-white-light p-[12px] dark:border-[#1b2e4b]">
                        <h5 className="h5-dashboard mb-1 text-base leading-none dark:text-white">Navbar Type</h5>
                    ...
                    <div className="mb-[12px] rounded-md border border-dashed border-white-light p-[12px] dark:border-[#1b2e4b]">
                        <h5 className="h5-dashboard mb-1 text-base leading-none dark:text-white">Router Transition</h5>
