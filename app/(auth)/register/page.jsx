...
export default function Register() {
    ...
    const selectedCountryIso = listOfCountries.find((country) => country.value === selectedCountry)?.iso;

    const selectedStateIso = listOfStates.find((state) => state.value === selectedState)?.iso;
                                            ...
                                            <div className="form-group">
                                                <div className="box-remember">
                                                    <label className="font-xs color-grey-900" htmlFor="rememberme">
                                                        <input id="rememberme" type="checkbox" {...register('referredByGca')} />
                            ...
                            <div className="box-info-bottom-img box-info-bottom-img-3 flex flex-col items-start">
                                <div>
                                    <p className="font-sm color-white">
                                        Geo Cargo Alliance (GCA) unites independent freight forwarders globally, offering a network that enhances connectivity and delivers key resources for success in
                                        logistics.
                                    </p>
                                </div>
